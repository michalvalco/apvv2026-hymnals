...
1. `C:\Users\valco\OneDrive\Documents\06 Resources\Dejiny\` (general history)
2. `C:\Users\valco\OneDrive\Documents\06 Resources\Dejiny\Domace cirkevne dejiny\` (Slovak church history)
3. `C:\Users\valco\OneDrive\Documents\06 Resources\Liturgika\` (liturgy)
...
*Generated by Claude Opus 4.7 on 2026-05-10 as a meta-catalogue for TEPALIT-relevant local holdings. Source notes for individual items will be created in subsequent sessions where warranted, following the `Sources\_Source_Template.md` discipline. No git commits performed in this session.*
