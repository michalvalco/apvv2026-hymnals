...
| Lukáš Pražský | *O Puovodu cierkvie svaté* | 1522 (1st ed.); **1761 reprint** (Google Books copy) [**CORRECTED 2026-05-10** per `Survey_URLcheck_2026-05-10.md`; original entry said "1762"; the Google Books copy is the 1761 reprint, not the 1522 first edition] | Reprint digital scan | Google Play Books, id `j-xgAAAAcAAJ` | §4.2 (ecclesiology — *the* Luke ecclesiological text) |
