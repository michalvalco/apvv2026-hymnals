...
| Kolínský kancionál (1517) | `KancKolinsky_1517` | 📋 | Indexed in HTB (clavmon.cz/htb); single largest melodic source for older Czech repertoire absorbed into CS per Grešová-Sekelská 2021. Direct facsimile pending verification. | Utraquist printed hymnal. Source for `PAIR_001_AY_PANNA` Marian rubric ("Zdrawa genž sy pozdrawena"). |
